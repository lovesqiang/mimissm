        ...
        function fileChange(){//注意：此处不能使用jQuery中的change事件，因此仅触发一次，因此使用标签的：onchange属性
           // alert("change");
            $.ajaxFileUpload({
                ...
                fileElementId: 'shopImage',//文件上传控件的id属性  <input type="file" id="shopImage" name="shopImage" />
                ...
                success: function(obj) //服务器成功响应处理函数
                {
                    ...
                    var imgObj = $("<img>");
                    //给img标签对象追加属性
                    imgObj.attr("src","/image/"+obj.imgurl);
				...
				<form action="${pageContext.request.contextPath}/prod/save.action"
					...
					<table>
						<tr>
							...
							<td><input type="text" name="shopName" class="two"></td>
						</tr>
						<!--错误提示-->
						<tr class="three">
							<td class="four"></td>
							<td><span id="shopNameerr"></span></td>
						</tr>
						<tr>
							<td class="one">商品介绍</td>
							<td><input type="text" name="shopIntroduce" class="two"></td>
						</tr>
						<!--错误提示-->
						<tr class="three">
							<td class="four"></td>
							<td><span id="shopIntroduceerr"></span></td>
						</tr>
						<tr>
							<td class="one">定价</td>
							<td><input type="number" name="shopPrice" class="two"></td>
						</tr>
						<!--错误提示-->
						<tr class="three">
							<td class="four"></td>
						...
						<tr>
                            ...
                            <td> <br><div id="imgDiv" style="display:block; width: 40px; height: 50px;"></div><br><br><br><br>
								<%--<input type="file" id="shopImage" name="shopImage" onchange="fileChange()">--%>
                            <input type="file" id="shopImage" name="shopImage" onchange="fileChange()" >
						...
						<tr>
							<td class="one">总数量</td>
							<td><input type="number" name="shopCount" class="two"></td>
						</tr>
						<!--错误提示-->
						<tr class="three">
							<td class="four"></td>
